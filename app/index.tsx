...
export default function HomeScreen() {
  ...
  const handleAction = (action: 'like' | 'pass') => {
    ...
    // Add logic to connect to Supabase later
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#F2F0E9' }, // Darker cream for contrast
  ...
  locationTag: {
    ...
    borderRadius: 20, backdropFilter: 'blur(10px)' // Works on iOS
  },
  locationText: { 
  ...
  // Prompt Box
  promptBox: {
    backgroundColor: COLORS.secondary, // Taupe
    padding: 20,
  ...
  likeBtn: { backgroundColor: '#FF4785' } // Hot Pink for Love
});